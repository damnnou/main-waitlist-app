...
export async function getFarcasterMetadata(): Promise<FrameManifest> {
    ...
    const ACCOUNT_ASSOCIATION_HEADER = process.env.FARCASTER_ACCOUNT_ASSOCIATION_HEADER;
    const ACCOUNT_ASSOCIATION_PAYLOAD = process.env.FARCASTER_ACCOUNT_ASSOCIATION_PAYLOAD;
    const ACCOUNT_ASSOCIATION_SIGNATURE = process.env.FARCASTER_ACCOUNT_ASSOCIATION_SIGNATURE;

    if (ACCOUNT_ASSOCIATION_HEADER && ACCOUNT_ASSOCIATION_PAYLOAD && ACCOUNT_ASSOCIATION_SIGNATURE) {
        accountAssociation = {
